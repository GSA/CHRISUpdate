                ...
                using (conn)
                {
                    ...
                    using (cmd)
                    {
                        ...
                        MySqlParameter[] personParameters = new MySqlParameter[]
                        {
                            ...
                            new MySqlParameter { ParameterName = "dateOfBirth", Value = hrData.Birth.DateOfBirth?.ToShortDateString(), MySqlDbType = MySqlDbType.TinyBlob},
                            new MySqlParameter { ParameterName = "gender", Value = hrData.Person.Gender, MySqlDbType = MySqlDbType.VarChar, Size = 1},
                            new MySqlParameter { ParameterName = "scdLeave", Value = hrData.Person.ServiceComputationDateLeave?.ToShortDateString(), MySqlDbType = MySqlDbType.Date},
                            ...
                            new MySqlParameter { ParameterName = "dateOfInvestigation", Value = hrData.Investigation.DateOfInvestigation?.ToShortDateString(), MySqlDbType = MySqlDbType.Date},
                            ...
                            new MySqlParameter { ParameterName = "initialResultDate", Value = hrData.Investigation.InitialResultDate?.ToShortDateString(), MySqlDbType = MySqlDbType.Date},
                            new MySqlParameter { ParameterName = "finalResult", Value = hrData.Investigation.FinalResult, MySqlDbType = MySqlDbType.Byte},
                            new MySqlParameter { ParameterName = "finalResultDate", Value = hrData.Investigation.FinalResultDate?.ToShortDateString(), MySqlDbType = MySqlDbType.Date},
                            ...
                            new MySqlParameter { ParameterName = "positionStartDate", Value = hrData.Position.PositionStartDate?.ToShortDateString(), MySqlDbType = MySqlDbType.Date},
